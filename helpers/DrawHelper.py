...
class DrawHelper:
    ...
    def board_tile_image(self, position):
        ...
        if os.path.exists(filepath):
            ...
            font = ImageFont.truetype("/usr/share/fonts/truetype/roboto", size=30)
            text = str(position)
    ...
    def display_techs(self):
        ...
        font = ImageFont.truetype("/usr/share/fonts/truetype/roboto", size=90)
        stroke_color = (0, 0, 0)
        stroke_width = 2
    ...
    def player_area(self, player):
        ...
        for x,action in enumerate(["explore","research","upgrade","build","move","influence"]):
            if action+"_action_counters" in player:
                ...
                if num > 1:
                    font = ImageFont.truetype("/usr/share/fonts/truetype/roboto", size=25)
                    stroke_color = (0, 0, 0)
                    color = (255, 255, 255)
                    stroke_width = 2
                    text_drawable_image = ImageDraw.Draw(context)
        ...
        font = ImageFont.truetype("/usr/share/fonts/truetype/roboto", size=50)
        stroke_color = (0, 0, 0)
        color = (0, 0, 0)
        stroke_width = 2
        text_drawable_image = ImageDraw.Draw(context)
